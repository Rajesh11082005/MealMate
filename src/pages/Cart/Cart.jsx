...
const Cart = () => {
    ...
    const { cartItems, food_list, removeFromCart, getTotalCartAmount, addToCart, currentUserState, setCartItems} = useContext(StoreContext)
                                            ...
                                            return (
                                                <div key={index}>
                                                    <div key={index} className="cart-items-title cart-items-item">
                                                        ...
                                                        <p>${Math.round((item.price * cartItems[currentUserState.currentUser.id][item.id]) * 100) / 100}</p>
                                                        <div className='cross'>
                                                            <div className="food-item-counter">
                                                                <img onClick={() => {
                                                                    removeFromCart(currentUserState.currentUser.id, item.id)
                                                                ...
                                                                <img onClick={() => {
                                                                    addToCart(currentUserState.currentUser.id, item.id)
                                                                    setCartItems({...cart.cartItems})
                            ...
                            <div className="cart-bottom">
                                <div className="cart-total">
                                    ...
                                    <div>
                                        ...
                                        <div className="cart-total-details">
                                            <p>Delivery Fee</p>
                                            <p>${getTotalCartAmount(currentUserState.currentUser.id) === 0 ? 0 : cart.DELIVERYFEE}</p>
                                        </div>
                                        <hr />
                                        <div className="cart-total-details">
                                            <p>Total</p>
